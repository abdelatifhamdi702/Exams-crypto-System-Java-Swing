...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        User = new controls.JTextBox(15,Color.BLUE);
        Pass = new controls.JPassBox(15,Color.BLUE);
        btnLogin1 = new controls.JMyBottom();
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btnExit1, btnLogin1});
...
static String type="";
    ...
    private void btnLogin1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLogin1ActionPerformed
        ...
        if (b==true)
        {
        type = go.getTypeByUser(user);
            JFrame f = new  Forms.mainForm();
            //f.setSize(430, 482);
            Tools.OpenForm(f);this.dispose();
        } else {
    ...
    private controls.JMyBottom btnLogin1;
